      ...
      child: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => TestVariantsScreen(subject: 'Математика'),
            ),
          );
        },
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(mathTasks[index].question),
                const SizedBox(height: 16),
                _buildAnswerButton(context, mathTasks[index].answer),
              ],
            ),
          ),
        );
