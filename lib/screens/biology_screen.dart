...
import '../models/biology_data.dart';
...
class _BiologyScreenState extends State<BiologyScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        padding: const EdgeInsets.only(top: 80), // Добавлен отступ сверху
      ...
      child: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => TestVariantsScreen(subject: 'Биология'),
            ),
          );
        },
 ...
 Widget _buildTheoryScreen() {
  return ListView.builder(
    ...
    itemCount: biologyTheory.length,
      ...
      return Card(
        ...
        child: Theme(
          data: Theme.of(context).copyWith(
            dividerColor: Colors.transparent, // Убираем черные полосы
          ),
          child: ExpansionTile(
            title: Text(
              biologyTheory[index].topic,
            ...
            children: [
              Container(
                color: Colors.white.withOpacity(0.9), // Цвет фона контента
                padding: const EdgeInsets.all(16.0),
                child: Text(
                  biologyTheory[index].content,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  biologyTasks[index].question,
                  style: const TextStyle(fontSize: 16),
                ),
                const SizedBox(height: 16),
                _buildAnswerButton(context, biologyTasks[index].answer),
              ],
            ),
          ),
        );
  ...
  return Container(
    height: 60, // Увеличена высота кнопки
    decoration: BoxDecoration(
    ...
    child: TextButton(
      ...
      style: TextButton.styleFrom(
        ...
        padding: const EdgeInsets.symmetric(vertical: 16), // Увеличен padding
      ),
      child: const Center(
        child: Text(
          'Показать ответ',
          style: TextStyle(
            fontSize: 20, // Увеличен размер текста
            fontWeight: FontWeight.bold,
            fontFamily: 'Klyakson',
          ),
        ),
  ...
  return Container(
    height: 55, // Увеличена высота кнопки
    decoration: BoxDecoration(
      image: DecorationImage(
        image: AssetImage('assets/images/handwritten_button.png'),
        fit: BoxFit.fill,
    ...
    child: TextButton(
      ...
      child: const Text(
        'Закрыть',
        style: TextStyle(
          fontSize: 18, // Увеличен размер текста
          fontWeight: FontWeight.bold,
          fontFamily: 'Klyakson',
        ),
      ),
