...
import '../models/obshchestvo_data.dart';
import 'test_variants_screen.dart';

class ObshchestvoScreen extends StatefulWidget {
  const ObshchestvoScreen({super.key});

  @override
  State<ObshchestvoScreen> createState() => _ObshchestvoScreenState();
}

class _ObshchestvoScreenState extends State<ObshchestvoScreen> {
      ...
      child: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => TestVariantsScreen(subject: 'Обществознание'),
            ),
          );
        },
  ...
  Widget _buildTheoryScreen() {
    return ListView.builder(
      ...
      itemCount: obshchestvoTheory.length,
            ...
            child: ExpansionTile(
              ...
              children: [
                Container(
                  ...
                  child: Text(
                    obshchestvoTheory[index].content,
  ...
  Widget _buildPracticeScreen() {
    return ListView.builder(
      padding: const EdgeInsets.all(16),
      itemCount: obshchestvoTasks.length,
      itemBuilder: (context, index) {
        return Card(
          margin: const EdgeInsets.only(bottom: 16),
          color: Colors.white.withOpacity(0.9),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(obshchestvoTasks[index].question),
                const SizedBox(height: 16),
                _buildAnswerButton(context, obshchestvoTasks[index].answer),
              ],
            ),
          ),
        );
